...
(use-package ligature
  ...
  (ligature-set-ligatures 'prog-mode
    '(;; Monaspace Texture Healing Sequences
      "ff" "fi" "fl" "ft" "ffi" "ffl" "mm" "mi" "imi" "ll" "li" "tt" "ti"

      ;; Standard Coding Ligatures
      "==" "===" "!=" "!==" "=\\" "=/=" "==" "=>" "==>" "=>="
      "<=" "<==" "<=>" "<=" "<->" "-->" "-<" "-<<" "->" "->>"
      "<<" "<<-" "<<=" "<<<" "<~" "<~~" "</" "</>" "~>" "~~>"
      "~-" "~@" "#_" "#[" "#(" "#{" "#?" "#=" "##" "###" "####"
...
(mason-setup
  (dolist (pkg '("tidy" "stylelint" "typescript-language-server"))
